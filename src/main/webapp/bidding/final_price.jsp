...
<body class="rel">
	<div class="header">
		<div class="header-t">
			<div class="w1200 auto"><img src="images/logo.png" alt="" class="mt10 l"><span class="logo-r l mt10 ml20">交易员后台</span>
	...
	<div class="w1200 auto contant rel">
		...
		<div class="c-left">
					...
					<li class="selected"><a href="">管理竞价</a>
                        <ul>
		...
		<div class="c-right c-right1">
            ...
            <div class="member-tit"><p>用户确认报价</p></div>
            <div class="member-main">
                <div class="detail-con">
                        <dl>
                            <dt>报价会员：</dt>
                            ...
                            <dd><p>李四</p></dd>
                            <dt>地址：</dt>
                            <dd><p>广东省  深圳市   宝安区    XXXXXX工业园</p></dd>
                            <dt>联系手机：</dt>
                            <dd><p>138****8765</p></dd>
                        </dl>
                    </div>
                <div class="lib-tab5 xg-fb">
                    ...
                    <span class="f16 g3 mb10 dib ml30">报价单：
</span>
<table>
                            <thead>
                                <tr>
            ...
            <div class="member-tit"><p>操作日志</p></div>
            <div class="member-main">
                <div class="lib-tab5 xg-fb">
                    <table width="100%">
                        <thead>
