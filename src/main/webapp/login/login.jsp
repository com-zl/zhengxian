        ...
        <div class="content-reg">
            ...
            <div class="login-form">
                ...
                <div class="login-left">
                    <img src="static/1-2/images/login-pic.png" alt="">
                </div>
                <!-- 登录右 -->
                <div class="login-right">
                    <form action="users/login" method="post">
                        <div class="controls">
                            ...
                            <input name="loginname" type="text" class="input03 w400">
                        </div>
                        <div class="controls">
                            <div class="login-controls">
                                <p>密码：</p>
                            ...
                            <input name="loginpwd" type="text" class="input03 w400">
                        </div>
                        <div class="controls">
                            <div class="login-controls">
                                <p>验证码：</p>
                            ...
                            <img src="static/1-2/images/login-code.png" alt="" class="code-img">
