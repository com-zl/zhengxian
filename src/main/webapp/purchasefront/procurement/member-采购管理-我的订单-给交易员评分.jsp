...
<head lang="en">
    ...
    <title>供应商管理-采购管理-我的订单-给交易员评分</title>
...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">给交易员评分</a>
        </div>
         <!-- 会员左侧 -->
         ...
         <div class="member-right">
            ...
            <div class="order-received">
               <div class="member-subtit">订单详情</div>
               <table>
                   <tr class="order-tit">
                       <td colspan="7">
            ...
            <!-- 交易员 -->
            <div class="member-detailtit">交易员</div>
            <div class="detail-con">
               <dl>
                    <dd><p>华南区--张三   18688738756</p></dd>
               </dl>
            </div>
            <!-- 服务评价 -->
            <div class="member-detailtit">服务评价</div>
            <div class="controls">
                <div class="controls-radio">
                     <input type="radio" name="radio05" class="radio">
                     <i>非常满意</i>
                </div>
                <div class="controls-radio">
                     <input type="radio" name="radio05" class="radio">
