...
<head lang="en">
    ...
    <title>供应商管理-采购管理-我的订单-上传交易凭证</title>
...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">上传交易凭证</a>
        </div>
         <!-- 会员左侧 -->
        ...
        <!-- 会员右侧 -->
         <div class="member-right">
            <div class="member-tit"><p>上传交易凭证</p></div>
            <div class="member-con">
                <div class="controls">
                    <p><span>*</span>点击选择图片：</p>
                    ...
                    <div class="tip">
                        <em>说明：图片请上传jpg、png、GIF格式。图片大小不能超过3M形</em>
                    </div>
                </div>
