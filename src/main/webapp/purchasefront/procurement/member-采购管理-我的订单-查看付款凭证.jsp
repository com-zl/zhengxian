...
<head lang="en">
    ...
    <title>供应商管理-采购管理-我的订单-查看付款凭证</title>
...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">查看付款凭证</a>
        </div>
         <!-- 会员左侧 -->
        ...
        <!-- 会员右侧 -->
         <div class="member-right">
            <div class="member-tit"><p>查看付款凭证</p></div>
            <div class="member-con">
                <div class="controls">
                    <p>点击预览大图：</p>
                    <div class="upload-controls">
                        <div class="upload-img sfz-img preview-img">
                            <img src="images/upload-img02.png" alt="">
                        </div>
                        <input type="button" value="重新上传" class="upload-btn w148">
                    </div>
                </div>
                <input type="submit" value="保存" class="btn01 submit w148">
            </div>
         </div>
    </div>
</div>
