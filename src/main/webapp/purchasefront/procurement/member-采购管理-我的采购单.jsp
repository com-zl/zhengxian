...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">我的采购单</a>
        </div>
         <!-- 会员左侧 -->
                    ...
                    <dd>
                        ...
                        <div class="search-btn">
                            <input type="submit" class="btn03" value="检索">
                             <a href="javascript:;" class="btn02">发布采购单</a>
                        </div>
                    </dd>
                </dl>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span>待审核</span></td>
                            <td>
                                <a href="javascript:;" class="btn04">详细</a>
                            </td>
                        </tr>
                        <tr>
                            <td>201401448</td>
                            ...
                            <td>采购牛肉2.5吨，简介资源单简介资源单简介资源单简介资源单简介资源单简介...</td>
                            <td>2015-05-05 14:15</td>
                            <td><span style="color: #e42122;">已关闭</span></td>
                            <td>
                                <a href="javascript:;" class="btn04">详细</a>
                                <a href="javascript:;" class="btn04">删除</a>
                            </td>
                        </tr>
                        <tr>
                            <td>201401448</td>
                            ...
                            <td>采购牛肉2.5吨，简介资源单简介资源单简介资源单简介资源单简介资源单简介...</td>
                            <td>2015-05-05 14:15</td>
                            <td><span style="color: #146eb6;">进行中</span></td>
                            <td>
                                <a href="javascript:;" class="btn04">详细</a>
                                <a href="javascript:;" class="btn04">删除</a>
                            </td>
                         ...
                         <tr>
                            ...
                            <td>采购牛肉2.5吨，简介资源单简介资源单简介资源单简介资源单简介资源单简介...</td>
                            <td>2015-05-05 14:15</td>
                            <td><span style="color: #146eb6;">已完成</span></td>
                            <td>
                                <a href="javascript:;" class="btn04">详细</a>
                                <a href="javascript:;" class="btn04">删除</a>
                            </td>
