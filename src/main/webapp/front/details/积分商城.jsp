...
<div class="content">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <a href="javascript:;" class="selected">积分商城</a>
        </div>
        <!-- 内容主体区 -->
        <div class="content-main">
            <div class="jfsc">
                <div class="jfsc-banner">
                    <div class="banner-left">
                       <div id="bannerPoints" class="banner-jfsc">
                            <div class="hd">
                                <ul>
                                    <li class="on">1</li>
                                    <li>2</li>
                            ...
                            <div class="bd">
                                <ul>
                                    <li><a href="javascript:;" target="_blank"><img src="images/points-banner1.jpg"></a></li>
                                    <li><a href="javascript:;" target="_blank"><img src="images/points-banner1.jpg"></a></li>
                                    <li><a href="javascript:;" target="_blank"><img src="images/points-banner1.jpg"></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="banner-right">
                        <a href="javacritp:;"><img src="images/points-banner2.jpg" alt=""></a>
                        <a href="javacritp:;"><img src="images/points-banner3.jpg" alt=""></a>
                    </div>
                </div>
            <!-- 积分商城列表 -->
                   ...
                   <div id="con_two_1" style="display: block;">
                        <!-- 积分商城列表 -->
                          <dl class="list-jfsc">
                            <dd>
                                <a href="javascript:;">
                                <img  class="show-pic" src="images/points-pic01.jpg" alt="">
                                </a>
                                <div class="points"><span>2346</span>积分</div>
                                <h6>XXX品牌最具特色杯子形状玻璃工艺品（最具创意）</h6>
                                <a href="javascript:;" class="exchange">立即兑换</a>
                                <div class="mask"></div>
                            </dd>
                            <dd>
                                <a href="javascript:;">
                                <img  class="show-pic" src="images/points-pic02.jpg" alt="">
                                </a>
                                <div class="points"><span>2346</span>积分</div>
                                <h6>XXX品牌最具特色杯子形状玻璃工艺品（最具创意）</h6>
                                <a href="javascript:;" class="exchange">立即兑换</a>
                            ...
                            <dd>
                                <a href="javascript:;">
                                <img  class="show-pic" src="images/points-pic03.jpg" alt="">
                                </a>
                                <div class="points"><span>2346</span>积分</div>
                                <h6>XXX品牌最具特色杯子形状玻璃工艺品（最具创意）</h6>
                                <a href="javascript:;" class="exchange">立即兑换</a>
                            ...
                            <dd>
                                <a href="javascript:;">
                                <img  class="show-pic" src="images/points-pic04.jpg" alt="">
                                </a>
                                <div class="points"><span>2346</span>积分</div>
                                <h6>XXX品牌最具特色杯子形状玻璃工艺品（最具创意）</h6>
                                <a href="javascript:;" class="exchange">立即兑换</a>
...
<script type="text/javascript">
    ...
    jQuery("#bannerPoints").slide({mainCell:".bd ul",autoPlay:true});
