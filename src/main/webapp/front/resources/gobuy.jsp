...
<head lang="en">
    ...
    <script>
    	function addtotal(){
    		var t = (${product.proPrice})*$(".num-input").val();
    		$("#total").html(t);
    	}
    	
    	function gocharge(){
    		var r = confirm("确定是否支付？");
    		if(r==true){
    			location="hyf/rc/gc?proid=${proid}";
    		}else{
...
<!-- 内页banner -->
<a class="banner-page" href="javascript:;" style=" background: url(static/1-2/images/banner-page01.jpg) no-repeat center"></a>
<!-- 网站内容区 -->
<div class="content">
    <div class="container">
        <!-- 面包屑导航 -->
        <div class="bread-crumbs">
            ...
            <a href="javascript:;" class="selected">购物车</a>
        </div>
        <!-- 内容主体区 -->
        <div class="content-main">
            <div class="member-tit"><p>我的购物车</p></div>
             <!-- 我收到的订单 -->
            <div id="cart">
               <table>
                   <thead>
                       <tr>
                           <th width="70px;"><input type="checkbox" class="check-all" name="checkAll" id="checkAll01"><label for="checkAll01">全选</label></th>
                           <th>商品</th>
                           <th width="110px;">规格</th>
                           <th width="130px;">产地</th>
                           <th width="150px;">单价</th>
                           <th width="150px">数量(千克)</th>
                   ...
                   <tbody>
                       ...
                       <tr class="order-con">
                          <td><input type="checkbox"></td>
                           ...
                           <td>${product.proSpecific }</td>
                           <td>${product.proPlace }</td>
                           <td><em>￥${product.proPrice }</em>RMB/kg</td>
                           <td class="cart-num">
                               <a href="javascript:;" class="num-less">-</a>
                               <input type="text" class="num-input" value="0" onkeyup="addtotal();" />
                               <a href="javascript:;" class="num-add">+</a>
                           </td>
                           <td><em id="total">0</em></td>
                           <td><a href="javascript:;" class="cart-del">删除</a></td>
                       </tr>
                       
                   </tbody>
                   <tr class="accounts">
                       <td colspan="4">
                           <input type="checkbox" class="check-all" name="checkAll" id="checkAll02"><label for="checkAll02">全选</label>
                           <a href="javascript:;" class="del-all">删除</a>
                       </td>
                       <td colspan="4">
                           <div class="total-num">已选商品<em>4</em>件</div>
                           <div class="total-price">(不含运费)：¥1500.00</div>
                           <a href="javascript:gocharge();" class="accounts-btn">去结算</a>
                       </td>
                   </tr>
               </table>
            </div>
