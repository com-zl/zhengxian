...
<head lang="en">
    ...
    <script>
    		function addlist(){
        		$("#auto").append($(".tabs").prop("outerHTML"));
        	}
    ...
    <div class="container">
        ...
        <div class="search">
            ...
            <div class="search-list">
                ...
                <span>|</span>
                <a href="javascript:;" id="paigu">A级排骨肉</a>
                <span>|</span>
        ...
        <div id="zy-upload">
            <div class="member-right">
                ...
                <div class="member-upgrade">
                    <img src="static/1-2/images/member-upgrade02.png" alt="">
                </div>
                 <!-- 搜索表格 -->
                 <div class="lib-tab5">
                    <ul class="lib-menu">
                    ...
                    <div class="lib-content">
                        ...
                        <div class="child-content" style="display: none;">
                            <!-- 方法三 -->
                            <form action="hyf/rc/add" method="post">
                            <div class="method">
                                        ...
                                        <div class="method-table">
                                            ...
                                            <table class="tabs">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                           <select name="proCategory" class="w80">
                                                        ...
                                                        <td><input type="text" name="proName" value="鳗鱼" class="input05"></td>
                                                        <td><input type="text" name="proPlace" value="新加坡" class="input05"></td>
                                                        <td><input type="text" name="proSpecific" value="120g" class="input05"></td>
                                                        <td><input type="text" name="proGrade" value="A级" class="input05"></td>
                                                        <td><input type="text" name="proNum" value="1500" class="input05"></td>
                                                        <td><input type="text" name="proPrice" value="40" class="input05"></td>
                                                        <td>
                                                           <select name="money" class="w80">
                                                                <option value="0">请选择</option>
                                                                <option value="RMB">RMB</option>
                                                                <option value="USD">USD</option>
                                                            </select>
                                                        </td>
                                                        <td><input name="storeHouse" value="八达仓" type="text" class="input05"></td>
                                                        <td>
                                                           <select name="proCurrent" value="现货" class="w80">
                                                                <option value="0">请选择</option>
                                                                <option value="现货">现货</option>
                                                                <option value="期货">期货</option>
                                                            </select></td>
                                                        <td><input name="proRemarks" type="text" value="产品备注信息" class="input05"></td>
                                                        <td><a class="btn04 w65 del" onclick="deltr(this);">删除</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            
                                            </div>
                                            <a href="javascript:addlist();" class="btn09 add">增加</a>
                                        </div>
