...
<div class="content">
    <div class="container">
        ...
        <div class="content-reg">
            ...
            <!-- 注册表单 -->
            <div class="reg-form">
                <form action="tUsers/add" method="post">
                    <div class="controls">
                        <p>用户名：</p>
                        <input name="loginname" type="text" class="input03 w450">
                    </div>
                    <div class="controls">
                        <p>密码：</p>
                        <input name="loginpwd" type="text" class="input03 w450">
                    </div>
                    <div class="controls">
                        <p>确认密码：</p>
                        <input name="password" type="text" class="input03 w450">
                    </div>
                     <div class="controls">
                        <p>手机号：</p>
                        <input name="phone" type="text" class="input03 w450">
                    </div>
                    <div class="controls">
