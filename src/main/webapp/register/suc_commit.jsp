            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="menuPro-second">
                        ...
                        <a href="javascript:;" class="selected"><i class="fa fa-angle-right"></i>提交成功</a>
         ...
         <div class="member-right">
            <div class="member-main">
                <div class="member-column">
                    <div class="member-tit"><p>升级会员</p></div>
                     <div class="member-con">
                         <!-- 注册成功 -->
                          <div class="member-suc">
                              <h6><span>test</span>,您的信息已经成功提交<i class="fa fa-check-circle-o"></i></h6>
                              <p>您的信息已经成功提交，我们将尽快安排工作人员与您联系。审核工作预计在<span>48小时</span>内完成</p>
                          </div>
                     </div>
                </div>
            </div>
