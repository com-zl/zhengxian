...
<head lang="en">
    ...
    <base href="<%=basepath%>" />
    <title>超鲜网-资源</title>
    <link rel="stylesheet" href="1-2/css/public.css"/>
    <link rel="stylesheet" href="1-2/css/page.css"/>
    <link rel="stylesheet" href="1-2/css/banner.css"/>
    <link rel="stylesheet" href="1-2/css/tab.css"/>
    <link rel="stylesheet" href="1-2/css/table.css"/>
    <link rel="stylesheet" href="1-2/css/select.css">
    <link rel="stylesheet" href="1-2/css/font-awesome.min.css">
    <link rel="stylesheet" href="1-2/css/font-awesome-ie7.css">
    <!--[if lt IE 10]>
    <script src="1-2/js/html5shiv.min.js"></script>
    <![endif]-->
</head>
<body>
<!--网站顶部-->
        ...
        <div class="top-right">
            ...
            <div class="attention">
                ...
                <a class="weixin" href="javascript:;">
                    <img src="1-2/images/top-icon01.png" alt=""/>
                    <div class="weixin-erweima">
                        <i></i>
                        <img src="1-2/images/erweima.png" alt=""/>
                    </div>
                </a>
                <a class="xl" href="javascript:;"><img src="1-2/images/top-icon02.png" alt=""/></a>
                <a class="tx" href="javascript:;"><img src="1-2/images/top-icon03.png" alt=""/></a>
                <span>|</span>
            </div>
...
<header>
    <div class="container">
         <a href="javascript:;" class="logo">
           <img src="1-2/images/logo.png" alt=""/>
         </a>
        <div class="search">
                ...
                <ul>
                    <li class="pro-sort">
                        ...
                        <div class="sort-second">
                            ...
                            <a class="second-add" href=""><img src="1-2/images/sort-add01.jpg" alt=""/></a>
                        </div>
                    </li>
                    <li class="pro-sort">
                        <div class="sort-first">
...
<div class="content">
    <div class="container">
        ...
        <div class="content-main">
            ...
            <!--找货助手-->
            <div class="helpMe">
                <img src="1-2/images/helpMe-pic01.png" alt=""/>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="footer-top">
        <div class="container">
            <div class="footer-left">
                <div class="footer-logo"><img src="1-2/images/logo.png" alt=""/></div>
            ...
            <div class="footer-nav">
                <dl style="background: url(1-2/images/footer-icon01.png) no-repeat top left;">
                    <dt><a href="javascript:;">购物指南</a></dt>
                    <dd><a href="">购物流程</a><a href="">订货方式</a><a href="">联系客服</a><a href="">交易条款</a></dd>
                </dl>
                <dl style="background: url(1-2/images/footer-icon02.png) no-repeat top left;">
                    <dt><a href="javascript:;">支付方式</a></dt>
                    <dd><a href="">银行付款</a><a href="">在线支付</a><a href="">组合支付</a></dd>
                </dl>
                <dl style="background: url(1-2/images/footer-icon03.png) no-repeat top left;">
                    <dt><a href="javascript:;">物流帮助</a></dt>
                    <dd><a href="">如何找车</a><a href="">常见问题</a><a href="">运送流程</a></dd>
                </dl>
                <dl style="background: url(1-2/images/footer-icon04.png) no-repeat top left;">
                    <dt><a href="javascript:;">售后服务</a></dt>
                    <dd><a href="">售后服务总则</a><a href="">服务政策</a></dd>
                </dl>
                <dl style="background: url(1-2/images/footer-icon05.png) no-repeat top left;">
...
<script type="text/javascript" src="1-2/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="1-2/js/jquery.SuperSlide.2.1.1.js"></script>
<script type="text/javascript" src="1-2/js/global.js"></script>
<script type="text/javascript" src="1-2/js/jquery.accordion.js"></script>
<script type="text/javascript" src="1-2/js/select.js"></script>
