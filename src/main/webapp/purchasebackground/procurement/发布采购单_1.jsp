...
<base href="<%=basepath %>"/>
  <head>
    ...
    <link href="files/发布采购单_1/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/发布采购单_1/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u0" class="ax_形状">
        <img id="u0_img" class="img " src="images/修改发布_1/u0.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u2" class="ax_形状">
        <img id="u2_img" class="img " src="images/发布采购单_1/u2.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u14" class="ax_文本框_单行_">
        <input id="u14_input" type="text" value="张三"/>
      </div>
      ...
      <div id="u73" class="ax_单选框">
        ...
        <input id="u73_input" type="radio" value="radio" name="u73"/>
      </div>
      ...
      <div id="u76" class="ax_形状">
        <img id="u76_img" class="img " src="images/我的工作台/u3.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u78" class="ax_形状">
        <img id="u78_img" class="img " src="images/我的工作台/u5.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u80" class="ax_形状">
        <img id="u80_img" class="img " src="images/采购管理_1/u17.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u82" class="ax_形状">
        <img id="u82_img" class="img " src="images/我的工作台/u11.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u84" class="ax_形状">
        <img id="u84_img" class="img " src="images/我的工作台/u11.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u86" class="ax_文本">
        ...
        <div id="u87" class="text">
          <p><span style="color:#008000;">张三</span><span style="color:#333333;">&nbsp; |&nbsp; 欢迎您登录！&nbsp; |&nbsp; [注销]&nbsp; |&nbsp; </span><a id="u88" class="link"><span style="color:#0000FF;">帐号设置</span></a></p>
        </div>
      </div>

      <!-- Unnamed (形状) -->
      <div id="u89" class="ax_形状">
        <img id="u89_img" class="img " src="images/我的工作台/u11.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u91" class="ax_形状">
        <img id="u91_img" class="img " src="images/我的工作台/u9.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u93" class="ax_形状">
        <img id="u93_img" class="img " src="images/我的工作台/u11.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u95" class="ax_形状">
        <img id="u95_img" class="img " src="images/我的工作台/u11.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u97" class="ax_形状">
        <img id="u97_img" class="img " src="images/我的工作台/u11.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u101" class="ax_下拉列表框">
        <select id="u101_input">
          <option selected value="请选择采购商">请选择采购商</option>
        </select>
      </div>
      ...
      <div id="u103" class="ax_形状">
        <img id="u103_img" class="img " src="images/首页/u13.png"/>
        <!-- Unnamed () -->
